  ...
  switch (selector) {
    case "+":
      ...
      if (Number.isNaN(calculo)) {
        document.getElementById("resultado").innerHTML = `Insira soma válido!`
      }
      else {
    ...
    case "-":
      calculo = Math.round((n1 - n2))
      if (Number.isNaN(calculo)) {
        document.getElementById("resultado").innerHTML = `Insira subtração válida!`
      }
      else {
    ...
    case "*":
      calculo = Math.round((n1 * n2))
      if (Number.isNaN(calculo)) {
        document.getElementById("resultado").innerHTML = `Insira a multiplicação válida!`
      }
      else {
